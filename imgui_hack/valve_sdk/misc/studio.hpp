...
struct mstudiobbox_t
{
    ...
    std::optional<const char*> GetName()
    {
...
struct mstudiohitboxset_t
{
	...
	std::optional<mstudiobbox_t*> GetHitbox(int i)
    {
        if(i > numhitboxes) 
			return {};
...
public:
    ...
    std::optional<mstudiohitboxset_t*> GetHitboxSet(int i)
    {
        if(i > numhitboxsets) 
			return {};
    ...
    std::optional<mstudiobone_t*> GetBone(int i)
    {
        if(i > numbones) 
			return {};
